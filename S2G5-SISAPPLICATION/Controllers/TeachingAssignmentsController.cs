...
namespace S2G5_SISAPPLICATION.Controllers
{
    public class TeachingAssignmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors, "InstructorID", "InstructorFname");
        ...
        public ActionResult Create([Bind(Include = "InstructorID,CourseID,TermID,ID")] TeachingAssignments teachingAssignments)
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors, "InstructorID", "InstructorFname", teachingAssignments.InstructorID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstructorID,CourseID,TermID,ID")] TeachingAssignments teachingAssignments)
        {
            if (ModelState.IsValid)
            {
